    ...
    extends TestCase
{
    ...
    public void testTortoiseFilter()
    {
    	...
    	input += "{\"id\":0,\"top\":896,\"position\":194,\"nbDevant\":4,\"total\":10},";
    	input += "{\"id\":1,\"top\":896,\"position\":189,\"nbDevant\":6,\"total\":10},";
    	input += "{\"id\":2,\"top\":896,\"position\":199,\"nbDevant\":2,\"total\":10},";
    	input += "{\"id\":3,\"top\":896,\"position\":185,\"nbDevant\":8,\"total\":10},";
    	input += "{\"id\":4,\"top\":896,\"position\":192,\"nbDevant\":5,\"total\":10},";
    	input += "{\"id\":5,\"top\":896,\"position\":182,\"nbDevant\":9,\"total\":10},";
    	input += "{\"id\":6,\"top\":896,\"position\":206,\"nbDevant\":1,\"total\":10},";
    	input += "{\"id\":7,\"top\":896,\"position\":198,\"nbDevant\":3,\"total\":10},";
    	input += "{\"id\":8,\"top\":896,\"position\":187,\"nbDevant\":7,\"total\":10},";
    	input += "{\"id\":9,\"top\":896,\"position\":217,\"nbDevant\":0,\"total\":10}";
    	input += "] }";
    	
    	String output = "{\"id\":1,\"top\":896,\"nom\":\""+nomsBinome+"\",\"position\":189,\"nbDevant\":6,\"total\":10}";
    ...
    public void test1TortoisecomputeRank()
    {
    	...
    	String input = "{\"id\":1,\"top\":896,\"nom\":\""+nomsBinome+"\",\"position\":189,\"nbDevant\":6,\"total\":10}";
    ...
    public void test2TortoisecomputeRank()
    {
    	...
    	String input = "{\"id\":3,\"top\":3,\"nom\":\""+nomsBinome+"\",\"position\":2,\"nbDevant\":1,\"total\":10}";
